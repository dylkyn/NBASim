...
//	std::this_thread::sleep_for(duration);
	...
	boxScoreText.setFillColor(Color(0, 255, 0));
	...
	while (window.isOpen())
	{
		...
		if (roundFourCalc)
		{
			...
			for (int i = 0; i < leftColumnFour.size(); i += 2)
			{
				...
				std::cout << "Round 4 left Winner is: " << curr.getWinner().getName() << " the score was "
						  ...
						  << " and " << curr.getLoser().getGameScore() << std::endl;
				myText.setString(curr.getWinner().getName());
				myText.setFillColor(Color(0, 255, 0));
		...
		if (champCalc)
		{
			...
			winningCpts =
				curr.getWinner().getPlayer(4)->getNumTwo() * 2 + curr.getWinner().getPlayer(0)->getNumThree() * 3;
			...
			losingPGpts =
				curr.getLoser().getPlayer(0)->getNumTwo() * 2 + curr.getWinner().getPlayer(0)->getNumThree() * 3;
			...
			losingSGpts =
				curr.getLoser().getPlayer(1)->getNumTwo() * 2 + curr.getWinner().getPlayer(1)->getNumThree() * 3;
			...
			losingSFpts =
				curr.getLoser().getPlayer(2)->getNumTwo() * 2 + curr.getWinner().getPlayer(2)->getNumThree() * 3;
			...
			losingPFpts =
				curr.getLoser().getPlayer(3)->getNumTwo() * 2 + curr.getWinner().getPlayer(3)->getNumThree() * 3;
			...
			losingCpts =
				curr.getLoser().getPlayer(4)->getNumTwo() * 2 + curr.getWinner().getPlayer(0)->getNumThree() * 3;
