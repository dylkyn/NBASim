...
//			  << " and " << curr.getLoser().getGameScore() << std::endl;
	...
	while (window.isOpen())
	{
        ...
        Texture hawksLogo;
        Sprite hawksSprite = hawks.getLogo();
        window.draw(hawksSprite);
//        hawksLogo.loadFromFile("../graphics/hawks.png");
//        Sprite hawksSprite;
//        hawksSprite.setTexture(hawksLogo);
//        hawksSprite.setPosition(500, 500);
//        window.draw(hawksSprite);
		window.display();
	}
	return 0;
